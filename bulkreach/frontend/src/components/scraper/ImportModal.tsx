...
import { X, FileSpreadsheet, Target, Loader2, ArrowRight } from "lucide-react";
          ...
          >
            ...
            <div className="flex flex-col flex-1 min-w-0">
              ...
              <div className="p-5 sm:p-6 overflow-y-auto scrollbar-thin flex-1 space-y-6">
                <form id="import-form" onSubmit={onSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-rose-text leading-relaxed bg-rose-overlay/40 border-[3px] border-rose-border p-4 font-bold flex items-start gap-3 shadow-[3px_3px_0px_0px_var(--color-shadow)]">
                      <div className="mt-0.5 text-rose-pine shrink-0"><Target size={16} className="stroke-[2.5]" /></div>
                      <div>
                        Importing <strong className="text-rose-pine font-mono">{resultsCount}</strong> candidates.
                        They will be queued for sequence outreach immediately if the campaign is active.
                      </div>
                    </div>
                  </div>
                </form>
